...
async function run() {
    // Gallery (National Farmathon 2025 - Final Comprehensive Set)
    const gallery = [
    ...
    const programs = [
      ...
      },
      {
        ...
        "description": "Empowering communities with sustainabsle skills and livelihood opportunities."
      },
      {
      ...
      },
      {
        ...
        "description": "Promoting accessible transportation and mobility solutions for rural communities."
      },
      {
